package ariadna.ecommerce.auth.service;

import ariadna.ecommerce.auth.controller.LoginRequest;
import ariadna.ecommerce.auth.controller.RegisterRequest;
import ariadna.ecommerce.auth.controller.TokenResponse;
...
public class AuthService {
    ...
    private void revokeAllUserTokens(final User user) {
        final List<Token> validUserTokens = tokenRepository.findAllByUser_IdAndExpiredFalseAndRevokedFalse(user.getId());
